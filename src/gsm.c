...
void PrepareGSM(char *cmdline, struct GsmConfig_t *config)
{
    ...
    static const predef_vmode_struct predef_vmode[31] = {
        ...
        {GS_NONINTERLACED, GS_MODE_DTV_480P,    GS_FRAME, makeDISPLAY(447,  2559, 0,   3,   46,  700), makeSYNCV(6,  483,  3072, 30,  0,   6)},
        {GS_NONINTERLACED, GS_MODE_DTV_720P,    GS_FRAME, makeDISPLAY(447,  2559, 0,   3,   46,  700), makeSYNCV(5,  720,  0,    20,  0,   5)},}; //ends predef_vmode definition
    // clang-format on
