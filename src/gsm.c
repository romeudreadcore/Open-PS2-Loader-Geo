...
void PrepareGSM(char *cmdline, struct GsmConfig_t *config)
{
    ...
    //
    // clang-format off
    static const predef_vmode_struct predef_vmode[31] = {
        ...
        {GS_NONINTERLACED, GS_MODE_DTV_480P,    GS_FRAME, makeDISPLAY(479,  1535, 0,   1,   35,  200), makeSYNCV(6,  483,  3072, 30,  0,   6)},
        {GS_NONINTERLACED, GS_MODE_DTV_720P,    GS_FRAME, makeDISPLAY(1440,  2560, 1,   1,   24,  302), makeSYNCV(5,  720,  0,    20,  0,   5)},}; //ends predef_vmode definition
    // clang-format on
