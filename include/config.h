...
#define CONFIG_ITEM_GSMGEOMETRY         "$GSMGeometry"
#define CONFIG_ITEM_GSMWIDTH            "$GSMWidth"
#define CONFIG_ITEM_GSMHEIGHT           "$GSMHeight"
#define CONFIG_ITEM_GSMMAGH             "$GSMMAGH"
#define CONFIG_ITEM_GSMMAGV             "$GSMMAGV"
